                ...
                {activeCategory === 'agents' && (
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-10 pr-4 py-2 border border-input rounded-md text-sm focus:ring-2 focus:ring-ring focus:border-transparent w-64 bg-card text-foreground placeholder:text-muted-foreground"
                    />
                  </div>
                )}
                ...
                <div className="space-y-3">
                  {(() => {
                    ...
                    return filteredTools.map(tool => {
                      ...
                      return (
                        <label key={tool.id} className={`flex items-start gap-3 p-3 hover:bg-muted/60 rounded border border-border bg-card ${isRequired ? 'cursor-not-allowed bg-orange-50 dark:bg-orange-950/20' : 'cursor-pointer'}`}>
                          <input
                            type="checkbox"
